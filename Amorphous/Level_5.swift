...
class Level_5: Level {
    ...
    func initialize_variables() {
        ...
        print("reset the player in level 5")
    ...
    override func updateCamera() {
        if(currentPlayer != nil && currentPlayer?.position != nil) {
            ...
            let y = clamp(value: currentPlayer.position.y, lower: 20, upper: 2*UIScreen.main.bounds.width/2-10)
    ...
    func reformY(y: CGFloat) -> CGFloat {
        return clamp(value: y, lower: 20, upper: 2*UIScreen.main.bounds.width/2-10)
    }
